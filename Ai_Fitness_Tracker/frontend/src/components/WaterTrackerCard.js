    ...
    <GlassCard className="mb-6" neonBorder neonColor="#3b82f6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg font-black text-white">{current} / {goal} ml</p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button 
            onClick={() => onAdd(250)}
            className="w-9 h-9 rounded-lg bg-blue-500 flex items-center justify-center hover:opacity-90 transition-opacity"
          >
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex-1">
          <h3 className="text-base font-bold text-white mb-1">Stay Hydrated</h3>
