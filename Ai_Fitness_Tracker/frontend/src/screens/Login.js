    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-6 bg-black">
      <div className="w-full max-w-md glass-card p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white">FitAI</h1>
          <p className="text-gray-400">Your Personal AI Coach</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="text-right">
            <Link to="/forgot-password" size={20} className="text-primary text-sm font-medium hover:underline">
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <button className="flex justify-center items-center py-3 bg-secondary border border-gray-700 rounded-xl hover:bg-accent transition-all">
            <Chrome size={20} />
          </button>
          <button className="flex justify-center items-center py-3 bg-secondary border border-gray-700 rounded-xl hover:bg-accent transition-all">
            <Github size={20} />
